...
public class Job_Details_ClaimContacts  {
	...
	public void Testcase1_CreateJob() throws InterruptedException {
		...
		// Claim Contacts
		driver.findElement(By.xpath("//android.widget.LinearLayout[@content-desc=\"Claim Contacts\"]")).click();
		cf.myWait(3000);
		
//		driver.findElement(By.id("com.dki.dki:id/ll_project_manager")).isDisplayed();
//		cf.myWait(3000);
//		
//		driver.findElement(By.id("com.dki.dki:id/ll_technicians")).isDisplayed();
//		cf.myWait(3000);
//		
//		driver.findElement(By.id("com.dki.dki:id/ll_other_staff")).isDisplayed();
//		cf.myWait(3000);
