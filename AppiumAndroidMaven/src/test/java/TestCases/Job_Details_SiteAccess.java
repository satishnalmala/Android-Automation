...
public class Job_Details_SiteAccess  {
	...
	public void Testcase1_CreateJob() throws InterruptedException {
		...
		// Claim Contacts
		driver.findElement(By.xpath("//android.widget.LinearLayout[@content-desc=\"Site Access\"]")).click();
		cf.myWait(3000);
		
		driver.findElement(By.id("com.dki.dki:id/tv_access_codes")).isDisplayed();
		cf.myWait(3000);
		
		driver.findElement(By.id("com.dki.dki:id/tv_access_nodes")).isDisplayed();
		cf.myWait(3000);
