...
public class Job_Details_EmergencyServiceReport {
	...
	public void Testcase1_CreateJob() throws InterruptedException {
		...
		driver.findElement(By.xpath(
				"/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/androidx.drawerlayout.widget.DrawerLayout/android.widget.FrameLayout/android.widget.ExpandableListView/android.widget.LinearLayout[5]/android.widget.LinearLayout"))
				.click();

		cf.myWait(3000);
		System.out.println("Clicked Emergency Service report");

		
		
		driver.findElement(By.id("com.dki.dki:id/rb_yes")).click();
		cf.myWait(2000);
		System.out.println("clicked contents damaged button");
		
		/*driver.findElement(By.id("com.dki.dki:id/et_sub_explanation")).click();
		cf.myWait(2000);
		System.out.println("clicked explanation button");*/
		
		driver.findElement(By.id("com.dki.dki:id/et_sub_explanation")).sendKeys("explanation added");
		cf.myWait(2000);
		...
		driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/androidx.drawerlayout.widget.DrawerLayout/android.view.ViewGroup/android.view.ViewGroup/android.widget.FrameLayout/android.view.ViewGroup/androidx.recyclerview.widget.RecyclerView/android.view.ViewGroup[2]/android.widget.LinearLayout/android.view.ViewGroup/android.widget.EditText")).sendKeys("explanation for extraction added");
		cf.myWait(2000);
		System.out.println("added comments");
		
		driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/androidx.drawerlayout.widget.DrawerLayout/android.view.ViewGroup/android.view.ViewGroup/android.widget.FrameLayout/android.view.ViewGroup/androidx.recyclerview.widget.RecyclerView/android.view.ViewGroup[3]/android.widget.RadioGroup/android.widget.RadioButton[1]")).click();
		cf.myWait(3000);
		System.out.println("Clicked drying equipment ");
		
		driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/androidx.drawerlayout.widget.DrawerLayout/android.view.ViewGroup/android.view.ViewGroup/android.widget.FrameLayout/android.view.ViewGroup/androidx.recyclerview.widget.RecyclerView/android.view.ViewGroup[4]/android.widget.RadioGroup/android.widget.RadioButton[2]")).click();
		cf.myWait(2000);
		System.out.println("clicked emergency performed");
		
		driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/androidx.drawerlayout.widget.DrawerLayout/android.view.ViewGroup/android.view.ViewGroup/android.widget.FrameLayout/android.view.ViewGroup/androidx.recyclerview.widget.RecyclerView/android.view.ViewGroup[4]/android.widget.EditText")).sendKeys("explanation emergency extraction added");
		cf.myWait(2000);
		System.out.println("added emergency comments");
		
		driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/androidx.drawerlayout.widget.DrawerLayout/android.view.ViewGroup/android.view.ViewGroup/android.widget.FrameLayout/android.view.ViewGroup/androidx.recyclerview.widget.RecyclerView/android.view.ViewGroup[5]/android.widget.RadioGroup/android.widget.RadioButton[1]")).click();
		cf.myWait(2000);
		System.out.println("clicked asbestos performed");
		
		driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/androidx.drawerlayout.widget.DrawerLayout/android.view.ViewGroup/android.view.ViewGroup/android.widget.FrameLayout/android.view.ViewGroup/androidx.recyclerview.widget.RecyclerView/android.view.ViewGroup[6]/android.widget.RadioGroup/android.widget.RadioButton[2]")).click();
		cf.myWait(2000);
		System.out.println("clicked mold performed");
		
		driver.findElement(By.id("")).sendKeys("mold added");
		cf.myWait(2000);
		System.out.println("added emergency comments");
		
		/*driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/androidx.drawerlayout.widget.DrawerLayout/android.view.ViewGroup/android.view.ViewGroup/android.widget.FrameLayout/android.view.ViewGroup/androidx.recyclerview.widget.RecyclerView/android.view.ViewGroup[5]/android.widget.LinearLayout/android.view.ViewGroup/android.widget.EditText")).sendKeys("asbestos added");
		cf.myWait(2000);
		System.out.println("clicked asbestos performed");
